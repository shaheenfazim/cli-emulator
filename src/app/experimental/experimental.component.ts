    ...
    // });
     ...
     window.onload = function () {
         ...
         var commands = [
             ...
             {
                 command: 'pwd',
                 help   : 'List current working directory',
                 exec   : function () {
             ...
             },
             {
                 ...
                 help   : 'Find origin',
                 exec   : function () {
                     window.open('https://www.phinixs.com/');
                 }
             },
             {
                 command: 'flicker',
         ...
         var processCommand = function (chr: any) {
             ...
             if (command.startsWith("help")) {
                 ...
                 printCli("Welcome to cli-emulator, a dom based command-line to connect with the internet.\n\nCommands:\n" + out + "\nUse [info <command>] for more information.");
             }
                 ...
                 var checkCommand = command.split(" ")
                     ...
                     if(checkCommand[1] == "bin" || checkCommand[1] =="readme")
                     {
                 ...
                 if(commandEnd == "bin" || commandEnd == "readme")
                 {
                 ...
                 if (commandEnd === "bin" || commandEnd === "/bin") {
                     printCli("ls: bin: Permission denied");
                     valid = true;
                 }
 
     
                 if (!valid) {
                     printCli(`ls: cannot access '${commandEnd}': No such directory`);
                 }
             }     
                 ...
                 else if(allFiles.includes(commandEnd)){
                 ...
                 var commandEnd = command.substring("cd".length).trim();
     
                 var valid = false;
 
                 if (commandEnd === "bin" || commandEnd === "/bin") {
                     printCli("cd: bin: Permission denied");
                     valid = true;
                 }
                 if (commandEnd === "") {
                     resetLine();
                 ...
                 if (!valid) {
                     printCli(`cd: ${commandEnd}: No such directory`);
                 }
             }
                 ...
                 if (!valid) {
                     printCli(`Command ´${command}´ not found, type ´help´ for help.`);
                 }
             }
